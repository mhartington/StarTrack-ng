...
/* harmony import */ var _router_reuse_strat__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./router-reuse-strat */ "./src/app/router-reuse-strat.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
            ...
            providers: [
                {
                    ...
                    useClass: _router_reuse_strat__WEBPACK_IMPORTED_MODULE_7__["default"]
                }
            ],
...
var IonicRouteStrategy = /** @class */ (function () {
    ...
    IonicRouteStrategy.prototype.shouldDetach = function (route) {
        return false;
    };
    IonicRouteStrategy.prototype.store = function (route, detachedTree) { };
    IonicRouteStrategy.prototype.shouldAttach = function (route) {
        return false;
    };
    IonicRouteStrategy.prototype.retrieve = function (route) {
        return null;
    };
...
/* harmony default export */ __webpack_exports__["default"] = (IonicRouteStrategy);
