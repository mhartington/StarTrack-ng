    ...
    TrackDetailModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_6__["NgModule"])({
            imports: [
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_5__["RouterModule"].forChild([{ path: '', component: _track_detail_page__WEBPACK_IMPORTED_MODULE_4__["TrackDetailPage"] }])
            ],
            declarations: [_track_detail_page__WEBPACK_IMPORTED_MODULE_4__["TrackDetailPage"]],
            providers: [_providers_itunes_itunes_service__WEBPACK_IMPORTED_MODULE_3__["ItunesService"]]
        })
    ], TrackDetailModule);
...
var TrackDetailPage = /** @class */ (function () {
    function TrackDetailPage(events, 
    // public nativeMedia: NativeMedia,
    storage, toastCtrl, service, route) {
        this.events = events;
    ...
    TrackDetailPage.prototype.ngOnInit = function () {
        var _this = this;
        var id = this.route.snapshot.params.id;
        this.service.loadSong(id).subscribe(function (res) { return _this.track = res; }, function (err) { return console.log(err); }, function () { return _this.checkStorage(); });
    };
    ...
    TrackDetailPage = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./track-detail.page.scss */ "./src/app/pages/track-detail/track-detail.page.scss")]
        }),
