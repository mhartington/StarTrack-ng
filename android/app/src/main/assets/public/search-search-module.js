...
module.exports = ":host .thumbnail-md img,\n:host .thumbnail-ios img {\n  border-radius: 6px; }\n"
...
var SearchPage = /** @class */ (function () {
    function SearchPage(itunes, router, route) {
        this.itunes = itunes;
        this.router = router;
        this.route = route;
    ...
    SearchPage.prototype.searchCanceled = function (e) {
        e.target.blur();
    };
    ...
    SearchPage.prototype.ngOnInit = function () {
        ...
        this.searchInput.valueChanges
            ...
            .subscribe(function (results) { return (_this.listing = results); });
    };
