...
var AppModule = /** @class */ (function () {
    function AppModule(updates) {
        this.updates = updates;
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].production) {
            this.updates
                .activateUpdate()
                .then(function () { return console.log('updated in the background'); });
        }
    }
    AppModule = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_service_worker__WEBPACK_IMPORTED_MODULE_7__["SwUpdate"]])
    ], AppModule);
    return AppModule;
}());
...
module.exports = __webpack_require__(/*! /Users/mhartington/GitHub/StarTrack-ng/src/main.ts */"./src/main.ts");
